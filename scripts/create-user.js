...
// Verificar qual schema usar (SQLite local ou PostgreSQL)
const schemaPath = process.env.USE_SQLITE === 'true' 
  ? path.join(__dirname, '../prisma/schema-dev.prisma')
  : undefined;

const prisma = new PrismaClient({
  // Se usar SQLite, precisa gerar o client com o schema correto
  // Por enquanto, vamos tentar com o schema padrão
});
